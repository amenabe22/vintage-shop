            ...
            <div className="container mx-auto px-6 py-3">
                ...
                <nav className="sm:flex sm:justify-center sm:items-center mt-4">
                    <div className="flex flex-col sm:flex-row">
                        <a className="mt-3  text-gray-500 hover:text-gray-900 sm:mx-3 sm:mt-0 dark:hover:text-white" href="#">Home</a>
                        <a className="mt-3  text-gray-500 hover:text-gray-900 sm:mx-3 sm:mt-0 dark:hover:text-white" href="#">Shop</a>
                        <a className="mt-3  text-gray-500 hover:text-gray-900 sm:mx-3 sm:mt-0 dark:hover:text-white" href="#">Categories</a>
                        <a className="mt-3  text-gray-500 hover:text-gray-900 sm:mx-3 sm:mt-0 dark:hover:text-white" href="#">Contact</a>
                        <a className="mt-3  text-gray-500 hover:text-gray-900 sm:mx-3 sm:mt-0 dark:hover:text-white" href="#">About</a>
                    </div>
                </nav>
                <div className="mb-5">
